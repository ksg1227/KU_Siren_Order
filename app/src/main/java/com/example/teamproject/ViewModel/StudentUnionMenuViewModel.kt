...
class StudentUnionMenuViewModel : ViewModel() {
    ...
    val PopoItems = mutableStateListOf(
        ...
        MenuItem(R.drawable.firepopo, "분짜", "6300", 1,"Popo", 4),
    )

    val DonggasItems = mutableStateListOf(
        MenuItem(R.drawable.wangdon, "왕돈가스", "6300", 1,"Donggas", 0),
    ...
    val GookbabItems = mutableStateListOf(
        MenuItem(R.drawable.wangdon, "물냉면", "6000", 1,"Gookbab", 0),
        MenuItem(R.drawable.wangdon, "비빔냉면", "6000", 1,"Gookbab", 1),
    ...
    val BoonsikItems = mutableStateListOf(
        MenuItem(R.drawable.curry, "황소라면", "3500", 1, "Boonsik",0),
        MenuItem(R.drawable.curry, "건대떡볶이", "3500", 1,"Boonsik",1),
        MenuItem(R.drawable.curry, "와우라볶이", "5500", 1,"Boonsik",2),
        MenuItem(R.drawable.curry, "성적순대", "4000", 1,"Boonsik",3),
        MenuItem(R.drawable.curry, "폭풍튀김", "4000", 1,"Boonsik",4),
        MenuItem(R.drawable.curry, "장학금주먹밥", "2500", 1,"Boonsik",5),
        MenuItem(R.drawable.curry, "날치알주먹밥", "3000", 1,"Boonsik",6),
        MenuItem(R.drawable.curry, "라면+주먹밥", "5500", 1,"Boonsik",7),
        MenuItem(R.drawable.curry, "떡순이", "4500", 1,"Boonsik",8),
        MenuItem(R.drawable.curry, "떡튀기", "4500", 1,"Boonsik",9),
        MenuItem(R.drawable.curry, "떡튀순", "7000", 1,"Boonsik",10)
    )

    val MaraItems = mutableStateListOf(
        MenuItem(R.drawable.curry, "마라탕 기본", "5900", 1,"Mara",0),
        MenuItem(R.drawable.curry, "소고기마라탕", "7400", 1,"Mara",1),
        MenuItem(R.drawable.curry, "부대마라탕", "7800", 1,"Mara",2),
        MenuItem(R.drawable.curry, "몽땅마라탕", "8800", 1,"Mara",3),
        MenuItem(R.drawable.curry, "미니꼬바로우", "3800", 1,"Mara",4),
        MenuItem(R.drawable.curry, "만두튀김", "1800", 1,"Mara",5),
        MenuItem(R.drawable.curry, "K 짜장", "4500", 1,"Mara",6),
        MenuItem(R.drawable.curry, "마라 짜장", "5900", 1,"Mara",7)
    )

    val FirstfloorItems = mutableStateListOf(
        MenuItem(R.drawable.curry, "고추장제육볶음", "5900", 20,"Firstfloor",0),
        MenuItem(R.drawable.curry, "커리돈까스", "5500", 16,"Firstfloor",1),
        MenuItem(R.drawable.curry, "KU백반", "5300", 15,"Firstfloor",2),
        MenuItem(R.drawable.curry, "순두부라면", "3900", 11,"Firstfloor",3),
        MenuItem(R.drawable.curry, "새우튀김우동", "4800", 13,"Firstfloor",4)
    )
