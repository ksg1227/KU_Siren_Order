...
class ManagementRestioMenuViewModel : ViewModel() {
    ...
    val productsHot = mutableStateListOf(
        ...
        MenuItem(R.drawable.yeonuhot, "건국연유라떼", "3,000원", 999, "커피 HOT", 4),
    ...
    val productsTea = mutableStateListOf(
        ...
        MenuItem(R.drawable.img_tea_ice_peach, "달고나라떼", "3,500원", 999, "티라떼|아이스티", 4),
        ...
        MenuItem(R.drawable.img_dalgonamilk, "달고나밀크티", "3,500원", 999, "티라떼|아이스티", 12)
    )
    ...
    val productsAdeTeabag = mutableStateListOf(
        ...
        MenuItem(R.drawable.img_adeteabag_citronmint, "유자민트티", "2,900원", 999, "에이드|티백", 5),
        MenuItem(R.drawable.img_adeteabag_blueberry, "블루베리에이드", "2,800원", 999, "에이드|티백", 5),
        MenuItem(R.drawable.img_adeteabag_greengrape, "청포도에이드", "2,800원", 999, "에이드|티백", 7),
        MenuItem(R.drawable.img_adeteabag_grapefruit, "자몽에이드", "2,800원", 999, "에이드|티백", 8),
        MenuItem(R.drawable.img_adeteabag_lemon, "레몬에이드", "2,800원", 999, "에이드|티백", 9),
        MenuItem(R.drawable.img_peperminttea, "아이스 페퍼민트", "2,900원", 999, "에이드|티백", 10),
        MenuItem(R.drawable.img_adeteabag_citronmint, "아이스 유자민트티", "3,100원", 999, "에이드|티백", 11),
    )
    ...
    val bakery = mutableStateListOf(
        ...
        MenuItem(R.drawable.img_cookie_choco, "초코칩아몬드쿠키", "3,200원", 999, "베이커리", 2),
